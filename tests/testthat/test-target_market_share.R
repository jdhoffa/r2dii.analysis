...
test_that("target and projected `technology_share` are identical in start year (#265)", {
  ...
  expect_equal(
    out_projected$electric$technology_share,
    out_target$electric$technology_share
    )

  expect_equal(
    out_projected$ice$technology_share,
    out_target$ice$technology_share
  )
